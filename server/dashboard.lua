    ...
    if (not _AC_LAST_SAMPLE_TIME) or now - _AC_LAST_SAMPLE_TIME >= 60 then
        ...
        local payload = {
            ...
            data = {
                ...
                admins = AC_GetAdmins and AC_GetAdmins() or {},
                you = {
                    identifier = ACDB.getIdentifier(tonumber(playerId)),
                    perms = (function()
                        local a = AC_GetAdminByIdentifier and AC_GetAdminByIdentifier(ACDB.getIdentifier(tonumber(playerId)))
                        return (a and a.perms) or {}
                    end)()
                }
            }
        }
